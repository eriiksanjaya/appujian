...
print_r($_COOKIE);
die();*/
// if(!isset($_COOKIE['uploadURL'])) { die(); }
/*
...
$config['authentication'] = function () {
    return isset($_SESSION['guru_id']) && $_SESSION['guru_id'];
    // return true;
};
...
$config['licenseName'] = 'eriiksanjaya@gmail.com';
$config['licenseKey']  = '5JPW3C4VDABY432EAU7WE7KEB8KHCHQS';
...
$config['resourceTypes'][] = array(
    ...
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,mp3',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
