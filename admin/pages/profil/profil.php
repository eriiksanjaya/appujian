...
$data = mysqli_query($conn, "SELECT * FROM tb_admin WHERE admin_id = '$_SESSION[admin_id]'");
            ...
            <form role="form" method=POST action='<?php echo $aksi ?>'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="form-control" placeholder="Username" value="<?php echo $r['email']; ?>" required>
                </div>
