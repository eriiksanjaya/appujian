    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php  
          ...
          $data = mysqli_query($conn, "SELECT * FROM ujian_menu WHERE menu_status = '1' AND menu_isguru = '1' ORDER BY menu_sort ASC");
          while($row=mysqli_fetch_assoc($data))
          {
            ...
            if($row['menu_url'] == '')
            { 
              $__data = mysqli_query($conn, "SELECT * FROM ujian_menu_detail WHERE menudetail_status = '1' AND menudetail_isguru = '1' AND menudetail_menuid = '$row[menu_id]' ORDER BY menudetail_sort ASC");
          ...
          ?>
              ...
              <li class='treeview'>
                ...
                <?php  
                  $_data = mysqli_query($conn, "SELECT * FROM ujian_menu_detail WHERE menudetail_status = '1' AND menudetail_isguru = '1' AND menudetail_menuid = '$row[menu_id]' ORDER BY menudetail_sort ASC");
