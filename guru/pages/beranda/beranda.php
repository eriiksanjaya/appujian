    ...
    <section class="content">
      <div class="row">
        ...
        <a class="dashboard" href="pages.php?q=buat-soal">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-aqua"><i class="fa fa-list-alt"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">TUGAS</span>
                <span class="info-box-number"><?php echo app_count_tugas($_SESSION['guru_id'], $conn); ?></span>
              </div>
            </div>
          </div>
        </a>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo app_count_soal($_SESSION['guru_id'], $conn); ?></span>
              </div>
            </div>
          </div>
